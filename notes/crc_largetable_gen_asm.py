...
if __name__ == "__main__":
    ...
    tableasm = "../firmware64/large_table_crc.inc"
    ...
    FILE.write("    ;; Generated by Jacques Gagnon using modified crc.py script from Micah Dowty.\n")
    FILE.write("    ;; See notes/crc_largetable_gen_asm.py .\n")
    FILE.write("\n")

    for byte in xrange(256):
        FILE.write("    retlw   0x%02X    ; 0x%02X\n" % (table[byte], byte))
